...
export function makePopup(
  ...
  let mainWeatherIconURL = "../../assets/weather-icons/";
  ...
  if (windSpeed > 5) {
    ...
    <div
      class="popupWind"
    >
      <img class="popupWindIcon" src="../../assets/weather-icons/wind.svg"></img>${windSpeed.toFixed(0)} <span style="font-weight: 600; margin-left: 4px">${compassDirection}</span>
    </div>
    `
  }
