...
export async function up(db) {
 ...
 .addColumn('number_of_panels', 'integer', (col) => col.notNull())
 .addColumn('total_cost', 'decimal', (col) => col.notNull())
 .addColumn('roi_percentage', 'decimal', (col) => col.notNull())
 .addColumn('payback_period', 'integer', (col) => col.notNull())
 .addColumn('solar_generation', 'integer', (col) => col.notNull())
 .execute();
...
await db.schema
 ...
 .addColumn('ecological_footprint', 'integer', (col) => col.notNull())
 .execute();
...
await db.schema
 ...
 .addColumn('customer_id', 'integer', (col) => col.notNull().references('customer.customer_id'))
 .addColumn('carbon_footprint_id', 'integer', (col) => col.notNull().references('carbon_footprint_calculator.carbon_footprint_id'))
